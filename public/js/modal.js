...
function buildEventModalContent(event) {
  ...
  return `
    ...
    <p class="modal-subtitle">
      <strong style="color:var(--primary-teal);">${(!event.pricing || event.pricing === 'Free') ? 'FREE' : escapeHtml(event.pricing)}</strong>
    ...
    <div class="modal-event-meta">
      ...
      <div class="meta-block">
        ...
        <p>${(!event.pricing || event.pricing === 'Free') ? 'Free' : escapeHtml(event.pricing)}</p>
      </div>
      ${organizerHtml}
      <div class="meta-block">
